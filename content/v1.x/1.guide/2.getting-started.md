...
With Orion it can be acomplished in 3 simple steps:
...
color: amber
---
[Request classes](/v1.x/guide/security#validation) must extend `Orion\Http\Requests\Request` class instead of `Illuminate\Foundation\Http\FormRequest`
::
