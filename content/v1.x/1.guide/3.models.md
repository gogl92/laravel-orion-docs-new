...
To expose a model through API, first you need to create a controller for it. As you may have seen in the [Getting Started - Simple CRUD](/v1.x/guide/getting-started#simple-crud) section, defining a model controller is pretty straightforward.
