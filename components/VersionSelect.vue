  ...
  <div class="mb-3 lg:mb-6">
    ...
    >
      <UButton color="gray" class="w-full">
        <UIcon v-if="version.icon" :name="version.icon" class="w-4 h-4 flex-shrink-0 text-gray-600 dark:text-gray-300" />

        <span class="text-gray-900 dark:text-white">{{ version.label }}</span>

        <span class="text-gray-400 dark:text-gray-500">{{ version.suffix }}</span>
...
const { versions, version } = useContentSource()
</script>
